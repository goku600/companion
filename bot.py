"""
Telegram Bot + Groq AI Integration
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_html(
        ...
        "I'm powered by <b>Groq AI</b> (Llama 3.3 70B). You can:\n\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_html(
        "<b>Groq AI Telegram Bot — Help</b>\n\n"
        "<b>Commands:</b>\n"
        "/start — Welcome message\n"
        "/reset — Clear conversation history\n"
        "/help  — Show this help\n\n"
        "<b>How to use:</b>\n"
        "• Type any question and I'll answer using Groq AI (Llama 3.3 70B).\n"
...
async def handle_file_message(
    ...
    try:
        ...
        logger.exception("Error sending file to Groq: %s", exc)
        await message.reply_text(
